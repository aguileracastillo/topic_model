...
The next steps in the preparation of the data for the topic model include se visualizations are justSplit into train and test data set Define K perplexity Asmussen (more or less topics) granularity.
