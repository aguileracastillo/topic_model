...
The different indicators for goodness of fit and the iterative revision of these parameters with the training set led us to choose k=53 as an optimal number of topics to use with the unseen data. The code for the test set is in a separate script and can be found in the GitHub repository for this project.
