...
The digitalization process is allowing a more specific division of labor into the smallest possible tasks, opening more opportunities for the implementation of self-service solutions and facilitating scenarios for the co-production of public services [6], turning each citizen and user into "his or her own administrator, caseworker and bureaucrat" [7], and possibly generating administrative burden of citizens [8]. Therefore, it is deemed pertinent and timely to extend the scholarly exploration of the effects of technological change in the organization of work in public organizations and the potential consequences for the public sector workforce.

The public sector is a large adopter of technologies and commands a significant proportion of a nation's workforce to perform constitutional functions, provide public services, implement policy goals, and manage public organizations.
